...
class Document:
    ...
    def insert(self, character):
        ...
        to insert more than one character in one cell, you will get a
        TooMuchCharacters exception
    ...
    def delete(self):
        ...
        you will get the OutOfDocument.
        """

        if self.cursor.position >= len(self.characters):
            raise OutOfDocument('You can`t delete the symbol that doesnt '
                                'exist!')
